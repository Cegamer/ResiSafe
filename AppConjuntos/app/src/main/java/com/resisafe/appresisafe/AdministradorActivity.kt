...
import com.resisafe.appresisafe.databinding.ActivityAdministradorBinding
...
class AdministradorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val apiService = com.resisafe.appresisafe.RetrofitClient.apiService
        val context = this
        val token = com.resisafe.appresisafe.ManejadorDeTokens.cargarTokenUsuario(context)?.token;

        if (token != null) {
            apiService.getPerfil(idPerfil,token).enqueue(object : Callback<com.resisafe.appresisafe.PerfilesDTO> {
                override fun onResponse(
                    call: Call<com.resisafe.appresisafe.PerfilesDTO>,
                    response: Response<com.resisafe.appresisafe.PerfilesDTO>
                ) {
                ...
                override fun onFailure(call: Call<com.resisafe.appresisafe.PerfilesDTO>, t: Throwable) {
