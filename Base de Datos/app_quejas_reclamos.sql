...
CREATE TABLE `quejas_reclamos` (
  `idquejas_reclamos` int NOT NULL AUTO_INCREMENT,
  `idTipo` int NOT NULL,
  `quejaReclamo` varchar(4500) NOT NULL,
  `idConjunto` int NOT NULL,
  PRIMARY KEY (`idquejas_reclamos`),
  KEY `tipo_idx` (`idTipo`),
  KEY `conjunto_idx` (`idConjunto`),
  CONSTRAINT `conjunto` FOREIGN KEY (`idConjunto`) REFERENCES `conjunto` (`ID_CONJUNTO`),
  CONSTRAINT `tipo` FOREIGN KEY (`idTipo`) REFERENCES `tipos_quejas_reclamos` (`idtipos_quejas_reclamos`)
