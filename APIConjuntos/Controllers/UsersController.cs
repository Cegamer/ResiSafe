    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult Post(RegisterDTO registerInfo)
        {
            ...
            try
            {
                ...
                {
                    return new JsonResult(new { Message = "Usuario ya existe" });
                }
            }
        ...
        [HttpPost]
        [Route("Login")]
        public IActionResult Post([FromBody] LoginDTO loginInfo)
        {
            appContext dbContext = new appContext();
            ...
            loginInfo.Contraseña = UserUtilities.HashPassword(loginInfo.Contraseña);
            ...
            if (validLogin == null)
            {
                var problemDetails = new ProblemDetails
                {
                    ...
                    Title = "Cedula o contraseña incorrectos",
                    Detail = "LOGIN-01",
                };
        ...
        public IActionResult Get(int id)
        {
            ...
            {
                return new JsonResult(mapper.Map<UsuariosDTO>(dbContext.Usuarios.First(u => u.IdUsuario == id)));
            }
